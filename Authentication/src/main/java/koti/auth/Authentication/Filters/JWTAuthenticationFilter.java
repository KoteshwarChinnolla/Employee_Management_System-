package koti.auth.Authentication.Filters;
...
import koti.auth.Authentication.dtos.LoginRequest;
...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (!request.getServletPath().equals("/authenticate/generate-token")) {
        ...
        if (authResult.isAuthenticated()) {
            String token = jwtUtil.generateToken(authResult.getName(), 5); //150min
